...
void Simulation::high_level_banner() {
  ...
  NaluEnv::self().naluOutputP0() << std::endl;
  NaluEnv::self().naluOutputP0() << "=================================================================" << std::endl;
  NaluEnv::self().naluOutputP0() << "                         Mare-Nalu:                              " << std::endl;
  NaluEnv::self().naluOutputP0() << "    A low Mach number, COMERI-based unstructured flow code with  " << std::endl;
  NaluEnv::self().naluOutputP0() << "            coupling to PMR and object response (CHT)            " << std::endl;
  NaluEnv::self().naluOutputP0() << "=================================================================" << std::endl;
  NaluEnv::self().naluOutputP0() << std::endl;
  NaluEnv::self().naluOutputP0()
    << "   Mare-Nalu Version: " << version::NaluVersionTag << std::endl
    << "   Mare-Nalu GIT Commit SHA: " << version::NaluGitCommitSHA 
    << ((version::RepoIsDirty == "DIRTY") ? ("-" + version::RepoIsDirty) : "") << std::endl
    << "   Trilinos Version: " << version::TrilinosVersionTag << std::endl << std::endl;
  NaluEnv::self().naluOutputP0() << "   TPLs: HDF5, netCDF, STK, Trilinos, YAML_cpp and zlib   " << std::endl;
  ...
  NaluEnv::self().naluOutputP0() << std::endl;
  NaluEnv::self().naluOutputP0() << "                     Copyright 2025 COMERI                       " << std::endl;
  NaluEnv::self().naluOutputP0() << "  Modified code from Sandia Corporation's 2014 BSD-3 Copyright   " << std::endl;
  NaluEnv::self().naluOutputP0() << "      This software is released under the license detailed       " << std::endl;
  NaluEnv::self().naluOutputP0() << "     in the file, LICENSE, which is located in the top-level     " << std::endl;
  NaluEnv::self().naluOutputP0() << "                   Mare-Nalu directory structure                 " << std::endl;
  NaluEnv::self().naluOutputP0() << "-----------------------------------------------------------------" << std::endl;
  NaluEnv::self().naluOutputP0() << std::endl;
}
