...
// Class Definition
//==========================================================================
// AssembleMomentumEdgeSymmetrySolverAlgorithm - momentum at symmetry
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
AssembleMomentumEdgeSymmetrySolverAlgorithm::AssembleMomentumEdgeSymmetrySolverAlgorithm(
  Realm &realm,
  stk::mesh::Part *part,
...
//--------------------------------------------------------------------------
void
AssembleMomentumEdgeSymmetrySolverAlgorithm::initialize_connectivity()
{
    ...
    for ( stk::mesh::Bucket::size_type k = 0 ; k < length ; ++k ) {
      ...
      for ( int ip = 0; ip < num_face_nodes; ++ip ) {
        ...
        for (int i = 0; i < nDim; ++i ) {
          ...
          for ( int j = 0; j < nDim; ++j ) {
            const double axj = areaVec[faceOffSet+j];
            lhsFac = -viscBip*axi*axj*inv_axdx*nxnx;
