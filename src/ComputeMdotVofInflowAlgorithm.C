...
// Class Definition
//==========================================================================
// ComputeMdotVofInflowAlgorithm - bf mdot continuity inflow bc
//==========================================================================
//--------------------------------------------------------------------------
//-------- constructor -----------------------------------------------------
//--------------------------------------------------------------------------
ComputeMdotVofInflowAlgorithm::ComputeMdotVofInflowAlgorithm(
  Realm &realm,
  stk::mesh::Part *part,
  bool useShifted)
...
//--------------------------------------------------------------------------
void
ComputeMdotVofInflowAlgorithm::execute()
{
  stk::mesh::MetaData & meta_data = realm_.meta_data();
  ...
  for ( stk::mesh::BucketVector::const_iterator ib = face_buckets.begin();
    ...
    for ( stk::mesh::Bucket::size_type k = 0 ; k < length ; ++k ) {
      ...
      for ( int ip = 0; ip < numScsBip; ++ip ) {
        ...
        double vdot = 0.0;
        for ( int j=0; j < nDim; ++j ) {
          vdot += p_uIp[j]*areaVec[ip*nDim+j];
        }
        
        mdotInflow += rhoBip*vdot;
      }
    }
  }
